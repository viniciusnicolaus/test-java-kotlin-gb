package br.com.boticario.testkotlin.application.service.impl

import br.com.boticario.testkotlin.application.request.WarehouseRequest
import br.com.boticario.testkotlin.application.response.InventoryResponse
...
import br.com.boticario.testkotlin.factory.ProductFactory.createProduct
import br.com.boticario.testkotlin.factory.ProductFactory.createProductRequest
import br.com.boticario.testkotlin.factory.ProductFactory.inventoryRequest
import br.com.boticario.testkotlin.factory.ProductFactory.updateProduct
import br.com.boticario.testkotlin.factory.ProductFactory.updateProductRequest
...
internal class ProductServiceImplTest {
    ...
    fun `Given an update product request, When a all fields are input, Then must be overwrite all fields`() {
      val overwriteInventoryRequest = inventoryRequest.copy(
        mutableListOf(
          WarehouseRequest("SP", 42, WarehouseType.PHYSICAL_STORE),
          WarehouseRequest("RJ", 28, WarehouseType.ECOMMERCE)
        )
      )
